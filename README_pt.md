...
<p align="center">
  <a href="https://labex.io/pt/courses/nmap-fingerprinting-the-scripting-engine">
    <img src="https://course-cover.labex.io/nmap-fingerprinting-the-scripting-engine.png?lang=pt" alt="Impressão Digital com Nmap e o Scripting Engine">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/nmap-fingerprinting-the-scripting-engine)

## Exercícios

|   Índice | Nome                                       | Dificuldade   | Prática                                                                                                                                                          |
|----------|--------------------------------------------|---------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Detecção de Serviço e Versão               | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-service-and-version-detection-656142?course=nmap-fingerprinting-the-scripting-engine'>Iniciar Lab</a>    |
|        2 | Impressão Digital de Sistemas Operacionais | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-operating-system-fingerprinting-656141?course=nmap-fingerprinting-the-scripting-engine'>Iniciar Lab</a>  |
|        3 | Fundamentos do Nmap Scripting Engine (NSE) | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-nmap-scripting-engine-nse-basics-656140?course=nmap-fingerprinting-the-scripting-engine'>Iniciar Lab</a> |
|        4 | Varredura de Vulnerabilidades com NSE      | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-vulnerability-scanning-with-nse-656143?course=nmap-fingerprinting-the-scripting-engine'>Iniciar Lab</a>  |
|        5 | Desafio de Enumeração de Alvo              | Intermediário | <a target='_blank' href='https://labex.io/pt/labs/linux-target-enumeration-challenge-656139?course=nmap-fingerprinting-the-scripting-engine'>Iniciar Desafio</a> |
